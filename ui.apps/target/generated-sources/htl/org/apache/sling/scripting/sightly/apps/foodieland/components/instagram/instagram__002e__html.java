...
{
    Object var_testvariable0 = renderContext.getObjectModel().resolveProperty(_global_instagram, "imageReference");
    if (renderContext.getObjectModel().toBoolean(var_testvariable0)) {
        out.write("<div class=\"cmp-instagram__image\">\r\n\t\t");
        {
            Object var_testvariable1 = renderContext.getObjectModel().resolveProperty(_global_instagram, "link");
            if (renderContext.getObjectModel().toBoolean(var_testvariable1)) {
                out.write("<a");
                {
                    Object var_attrvalue2 = renderContext.getObjectModel().resolveProperty(_global_instagram, "link");
                    {
                ...
                out.write("> \r\n\t\t\t<img");
                {
                    Object var_attrvalue6 = renderContext.getObjectModel().resolveProperty(_global_instagram, "imageReference");
                    {
